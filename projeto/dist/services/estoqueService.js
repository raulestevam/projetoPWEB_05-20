...
class estoqueService {
    ...
    async cadastrarEstoque(estoqueInfo) {
        ...
        const novoEstoque = new Estoque_1.Estoque(id_carro, quantidade, localizacao_patio, dataEntradaObj);
    ...
    async atualizarEstoque(id, dadosAtualizacao) {
